...
public class Keypad implements ActionListener
{
	...
	Tappable method; // The converter object that maps keys to letters
	...
	public void actionPerformed(ActionEvent e)
	{
		...
		try
		{
			newText = method.append(oldText, i);
		...
		// System.out.println(title + ": " + (double) method.getNumPresses() /
		// newText.length() + " presses/char");
		frame.setVisible(true);
	}

	/**
	 * The constructor takes an object that handles key presses, and a String to use
	 * as the title of the window. It builds and displays the keypad, registering
	 * this object as the one to be notified when a button is pressed.
	 * 
	 * @param method
	 *            An object that interprets key presses
	 * @param title
	 *            A string to use as the window's title
	 */
	public Keypad(Tappable method, String title)
	{
		this.method = method;
		this.title = title;
